...
| Single-node Qwen3.8-Flash-Next vLLM serve (1× GB10) | [`0xBakeer/qwen38-flash-next-spark`](https://github.com/0xBakeer/qwen38-flash-next-spark) | Parameter/configuration reference only (longctx lane; MIT) |
