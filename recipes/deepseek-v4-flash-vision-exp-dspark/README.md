...
> 仓库内另有指向 0731 文本 checkpoint 的双节点（`deepseek-v4-flash-dspark`）与
> 四节点（`deepseek-v4-flash-0731-tp4-4x`）配方，按模型与拓扑需要选用。
...
> **2026-08-31 上游同步（v1.0.0）**：retarget 到 `DeepSeek-V4-Flash-Vision-Exp`
