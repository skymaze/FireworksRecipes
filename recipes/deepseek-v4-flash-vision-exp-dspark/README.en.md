...
> sidecar / MCP path. The repo also ships the 0731 text-checkpoint recipes
> (`deepseek-v4-flash-dspark` 2-node and `deepseek-v4-flash-0731-tp4-4x`
> 4-node); choose by model and topology.
...
> **2026-08-31 upstream sync (v1.0.0)**: retargeted to `DeepSeek-V4-Flash-Vision-Exp`
