...
| 配方 | 镜像 | 说明 |
|---|---|---|
| DeepSeek-V4-Flash-Vision-Exp (DSpark) | `registry.cn-shanghai.aliyuncs.com/aixn-public/dspark-vllm-gx10-mia:v0.1.1-hotfix3` | 双节点 TP=2 DSpark 服务 · **原生图片输入**（OpenAI image_url ≤8 张 / 仅 user 消息 / 无视频）· FlashInfer b12x + dspark 投机 k=6 · NVFP4 DS-MLA · **1M 上下文**（dev：镜像已烘焙推送，checkpoint 待实机验证） |
