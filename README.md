...
| 配方 | 镜像 | 说明 |
|---|---|---|
| DeepSeek-V4-Flash (DSpark) | `ghcr.io/anemll/dspark-vllm-gx10:0.1.1` | 双节点 TP=2 DSpark 服务 · FlashInfer b12x + dspark 投机 · NVFP4 DS-MLA · 1M 上下文 |
...
| GLM-5.3-Flash (DFlash2) | `registry.cn-shanghai.aliyuncs.com/aixn-public/glm53-flash-sm121:v8-dflash2` | **四节点 TP=4** · fp8 KV + **DFlash2** 块扩散投机（incoai drafter，KV 池成本 ~0）· **1M 上下文** · 单流 46.9 tok/s（MTP-4 的 2.15×） |
