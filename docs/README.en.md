...
| [DeepSeek-V4-Flash-Vision-Exp (DSpark)](../recipes/deepseek-v4-flash-vision-exp-dspark/README.md) | `registry.cn-shanghai.aliyuncs.com/aixn-public/dspark-vllm-gx10-mia:v0.1.1-hotfix5` | **2-node TP=2** (multimodal) · **native image input** (OpenAI image_url, ≤8 per request / user messages only / no video · incl. upstream vision fixes #168/#176/#179) · FlashInfer b12x + dspark spec k=6 · NVFP4 DS-MLA · **1M context** (dev: image baked & pushed, hotfix5; checkpoint hardware-validation pending) |
