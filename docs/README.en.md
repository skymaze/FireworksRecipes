...
|---|---|---|
| DeepSeek-V4-Flash-Vision-Exp (DSpark) | `registry.cn-shanghai.aliyuncs.com/aixn-public/dspark-vllm-gx10-mia:v0.1.1-hotfix3` | 2-node TP=2 DSpark · **native image input** (OpenAI image_url, ≤8 per request / user messages only / no video) · FlashInfer b12x + dspark spec k=6 · NVFP4 DS-MLA · **1M context** (dev: image baked & pushed; checkpoint hardware-validation pending) |
